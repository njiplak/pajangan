                            ...
                            <SidebarMenu>
                                ...
                                <SidebarMenuItem>
                                    <SidebarMenuButton
                                        asChild
                                        isActive={isMenuActive(
                                            backoffice.setting.payment.index.url(),
                                        )}
                                    >
                                        <Link
                                            href={backoffice.setting.payment.index.url()}
                                        >
                                            <CreditCard />
                                            <span>Payment</span>
                                        </Link>
                                ...
                                <SidebarMenuItem>
                                    <SidebarMenuButton
                                        asChild
                                        isActive={isMenuActive(
                                            backoffice.setting.shipping.index.url(),
                                        )}
                                    >
                                        <Link
                                            href={backoffice.setting.shipping.index.url()}
                                        >
                                            <Truck />
                                ...
                                <SidebarMenuItem>
                                    <SidebarMenuButton
                                        asChild
                                        isActive={isMenuActive(
                                            backoffice.product.index.url(),
                                        )}
                                    >
                                        <Link
                                            href={backoffice.product.index.url()}
                                        >
                                            <Package />
                                            <span>Produk</span>
                                        </Link>
                                ...
                                <SidebarMenuItem>
                                    <SidebarMenuButton
                                        asChild
                                        isActive={isMenuActive(
                                            backoffice.banner.index.url(),
                                        )}
                                    >
                                        <Link
                                            href={backoffice.banner.index.url()}
                                        >
                                            <GalleryHorizontal />
                                            <span>Banner</span>
                                        </Link>
                                ...
                                <SidebarMenuItem>
                                    <SidebarMenuButton
                                        asChild
                                        isActive={isMenuActive(
                                            backoffice.order.index.url(),
                                        )}
                                    >
                                        <Link
                                            href={backoffice.order.index.url()}
                                        >
                                            <ShoppingCart />
                                            <span>Pesanan</span>
                                        </Link>
                                ...
                                <SidebarMenuItem>
                                    <SidebarMenuButton
                                        asChild
                                        isActive={isMenuActive(
                                            backoffice.page.index.url(),
                                        )}
                                    >
                                        <Link
                                            href={backoffice.page.index.url()}
                                        >
                                            <FileText />
                                            <span>Halaman</span>
                                        </Link>
